...
static inline cmat2x2_t cmat2x2smul(cmat2x2_t a,complex float b) { cmat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cmat3x2_t cmat3x2smul(cmat2x2_t a,complex float b) { cmat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cmat3x3_t cmat3x3smul(cmat3x3_t a,complex float b) { cmat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cmat4x3_t cmat4x3smul(cmat2x2_t a,complex float b) { cmat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cmat4x4_t cmat4x4smul(cmat4x4_t a,complex float b) { cmat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }

static inline cmat2x2_t cmat2x2sdiv(cmat2x2_t a,complex float b) { cmat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cmat3x2_t cmat3x2sdiv(cmat2x2_t a,complex float b) { cmat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cmat3x3_t cmat3x3sdiv(cmat3x3_t a,complex float b) { cmat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cmat4x3_t cmat4x3sdiv(cmat2x2_t a,complex float b) { cmat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cmat4x4_t cmat4x4sdiv(cmat4x4_t a,complex float b) { cmat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
