...
static inline mat3x2_t mat3x2ortho(float xmin,float xmax,float ymin,float ymax)
{
	return mat3x2(2/(xmax-xmin),            0,-(xmax+xmin)/(xmax-xmin),
	                          0,2/(ymax-ymin),-(ymax+ymin)/(ymax-ymin));
}
static inline mat3x3_t mat3x3ortho(float xmin,float xmax,float ymin,float ymax) { return mat3x3affine3x2(mat3x2ortho(xmin,xmax,ymin,ymax)); }

static inline mat4x3_t mat4x3ortho(float xmin,float xmax,float ymin,float ymax,float zmin,float zmax)
{
	return mat4x3(2/(xmax-xmin),            0,             0,-(xmax+xmin)/(xmax-xmin),
	                          0,2/(ymax-ymin),             0,-(ymax+ymin)/(ymax-ymin),
				              0,            0,-2/(zmax-zmin),-(zmax+zmin)/(zmax-zmin));
	// -2 on z to match the OpenGL definition.
}
static inline mat4x4_t mat4x4ortho(float xmin,float xmax,float ymin,float ymax,float zmin,float zmax) { return mat4x4affine4x3(mat4x3ortho(xmin,xmax,ymin,ymax,zmin,zmax)); }
...
{
	float f=1/tanf(fovx*M_PI/180/2);
...
{
	float f=1/tanf(fovy*M_PI/180/2);
...
static inline mat2x2_t mat2x2smul(mat2x2_t a,float b) { mat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline mat3x2_t mat3x2smul(mat2x2_t a,float b) { mat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline mat3x3_t mat3x3smul(mat3x3_t a,float b) { mat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline mat4x3_t mat4x3smul(mat2x2_t a,float b) { mat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline mat4x4_t mat4x4smul(mat4x4_t a,float b) { mat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }

static inline mat2x2_t mat2x2sdiv(mat2x2_t a,float b) { mat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline mat3x2_t mat3x2sdiv(mat2x2_t a,float b) { mat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline mat3x3_t mat3x3sdiv(mat3x3_t a,float b) { mat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline mat4x3_t mat4x3sdiv(mat2x2_t a,float b) { mat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline mat4x4_t mat4x4sdiv(mat4x4_t a,float b) { mat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
...
static inline float mat2x2det(mat2x2_t m)
{
	return mat2x2_11(m)*mat2x2_22(m)-mat2x2_21(m)*mat2x2_12(m);
}

static inline float mat3x3det(mat3x3_t m)
{
	return mat3x3_11(m)*mat3x3_22(m)*mat3x3_33(m)
	      -mat3x3_11(m)*mat3x3_32(m)*mat3x3_23(m)
	      +mat3x3_21(m)*mat3x3_32(m)*mat3x3_13(m)
	      -mat3x3_21(m)*mat3x3_12(m)*mat3x3_33(m)
	      +mat3x3_31(m)*mat3x3_12(m)*mat3x3_23(m)
	      -mat3x3_31(m)*mat3x3_22(m)*mat3x3_13(m);
}

float mat4x4det(mat4x4_t m);

static inline float mat3x2affinedet(mat3x2_t m)
{
	return mat3x2_11(m)*mat3x2_22(m)-mat3x2_21(m)*mat3x2_12(m);
}

static inline float mat3x3affinedet(mat3x3_t m)
{
	return mat3x3_11(m)*mat3x3_22(m)-mat3x3_21(m)*mat3x3_12(m);
}

static inline float mat4x3affinedet(mat4x3_t m)
{
	return mat4x3_11(m)*mat4x3_22(m)*mat4x3_33(m)
	      -mat4x3_11(m)*mat4x3_32(m)*mat4x3_23(m)
	      +mat4x3_21(m)*mat4x3_32(m)*mat4x3_13(m)
	      -mat4x3_21(m)*mat4x3_12(m)*mat4x3_33(m)
	      +mat4x3_31(m)*mat4x3_12(m)*mat4x3_23(m)
	      -mat4x3_31(m)*mat4x3_22(m)*mat4x3_13(m);
}

static inline float mat4x4affinedet(mat4x4_t m)
{
	return mat4x4_11(m)*mat4x4_22(m)*mat4x4_33(m)
	      -mat4x4_11(m)*mat4x4_32(m)*mat4x4_23(m)
	      +mat4x4_21(m)*mat4x4_32(m)*mat4x4_13(m)
	      -mat4x4_21(m)*mat4x4_12(m)*mat4x4_33(m)
	      +mat4x4_31(m)*mat4x4_12(m)*mat4x4_23(m)
	      -mat4x4_31(m)*mat4x4_22(m)*mat4x4_13(m);
}
...
static inline mat2x2_t mat2x2inverse(mat2x2_t m)
{
	float det=mat2x2det(m); // singular if det==0

	return mat2x2( mat2x2_22(m)/det,-mat2x2_12(m)/det,
	              -mat2x2_21(m)/det, mat2x2_11(m)/det);
}
...
static inline vec2_t mat2x2transform(mat2x2_t m,vec2_t v)
{
	return vec2(v.x*mat2x2_11(m)+v.y*mat2x2_12(m),
	            v.x*mat2x2_21(m)+v.y*mat2x2_22(m));
}

static inline vec2_t mat3x2transform(mat3x2_t m,vec2_t v)
{
	return vec2(v.x*mat3x2_11(m)+v.y*mat3x2_12(m)+mat3x2_13(m),
	            v.x*mat3x2_21(m)+v.y*mat3x2_22(m)+mat3x2_23(m));
}
...
vec2_t mat3x3transformvec2(mat3x3_t m,vec2_t v);
vec3_t mat4x4transformvec3(mat4x4_t m,vec3_t v);
