...
static inline bool ivec2almostequal(ivec2_t a,ivec2_t b,int32_t epsilon) { return fabsf(a.x-b.x)<epsilon && fabsf(a.y-b.y)<epsilon; }
static inline bool ivec3almostequal(ivec3_t a,ivec3_t b,int32_t epsilon) { return fabsf(a.x-b.x)<epsilon && fabsf(a.y-b.y)<epsilon && fabsf(a.z-b.z)<epsilon; }
static inline bool ivec4almostequal(ivec4_t a,ivec4_t b,int32_t epsilon) { return fabsf(a.x-b.x)<epsilon && fabsf(a.y-b.y)<epsilon && fabsf(a.z-b.z)<epsilon && fabsf(a.w-b.w)<epsilon; }
...
static inline bool ivec2almostzero(ivec2_t v,int32_t epsilon) { return fabsf(v.x)<epsilon && fabsf(v.y)<epsilon; }
static inline bool ivec3almostzero(ivec3_t v,int32_t epsilon) { return fabsf(v.x)<epsilon && fabsf(v.y)<epsilon && fabsf(v.z)<epsilon; }
static inline bool ivec4almostzero(ivec4_t v,int32_t epsilon) { return fabsf(v.x)<epsilon && fabsf(v.y)<epsilon && fabsf(v.z)<epsilon && fabsf(v.w)<epsilon; }
...
static inline ivec2_t ivec2cmul(ivec2_t a,ivec2_t b) { return ivec2(imul(a.x,b.x),imul(a.y,b.y)); }
static inline ivec3_t ivec3cmul(ivec3_t a,ivec3_t b) { return ivec3(imul(a.x,b.x),imul(a.y,b.y),imul(a.z,b.z)); }
static inline ivec4_t ivec4cmul(ivec4_t a,ivec4_t b) { return ivec4(imul(a.x,b.x),imul(a.y,b.y),imul(a.z,b.z),imul(a.w,b.w)); }
...
static inline ivec2_t ivec2mac(ivec2_t a,ivec2_t b,int32_t c) { return ivec2(a.x+imul(b.x,c),a.y+imul(b.y,c)); }
static inline ivec3_t ivec3mac(ivec3_t a,ivec3_t b,int32_t c) { return ivec3(a.x+imul(b.x,c),a.y+imul(b.y,c),a.z+imul(b.z,c)); }
static inline ivec4_t ivec4mac(ivec4_t a,ivec4_t b,int32_t c) { return ivec4(a.x+imul(b.x,c),a.y+imul(b.y,c),a.z+imul(b.z,c),a.w+imul(b.w,c)); }
...
static inline ivec4_t ivec4homogenize(ivec4_t v) { return ivec4(idiv(v.x,v.w),idiv(v.y,v.w),idiv(v.z,v.w),F(1)); }
static inline ivec3_t ivec4homogenize3(ivec4_t v) { return ivec3(idiv(v.x,v.w),idiv(v.y,v.w),idiv(v.z,v.w)); }
...
static inline int32_t ivec3planepointdistance(ivec3_t p,ivec3_t v) { return idiv((ivec3dot(p,v)+F(1)),ivec3abs(p)); }
static inline int32_t ivec4planepointdistance(ivec4_t p,ivec3_t v) { return idiv(ivec4dot(p,ivec4vec3(v)),ivec3abs(ivec4_planenormal(p))); }
