...
static inline cdmat2x2_t cdmat2x2smul(cdmat2x2_t a,complex double b) { cdmat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cdmat3x2_t cdmat3x2smul(cdmat2x2_t a,complex double b) { cdmat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cdmat3x3_t cdmat3x3smul(cdmat3x3_t a,complex double b) { cdmat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cdmat4x3_t cdmat4x3smul(cdmat2x2_t a,complex double b) { cdmat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline cdmat4x4_t cdmat4x4smul(cdmat4x4_t a,complex double b) { cdmat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }

static inline cdmat2x2_t cdmat2x2sdiv(cdmat2x2_t a,complex double b) { cdmat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cdmat3x2_t cdmat3x2sdiv(cdmat2x2_t a,complex double b) { cdmat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cdmat3x3_t cdmat3x3sdiv(cdmat3x3_t a,complex double b) { cdmat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cdmat4x3_t cdmat4x3sdiv(cdmat2x2_t a,complex double b) { cdmat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline cdmat4x4_t cdmat4x4sdiv(cdmat4x4_t a,complex double b) { cdmat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
