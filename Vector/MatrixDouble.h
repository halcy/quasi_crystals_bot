...
static inline dmat2x2_t dmat2x2smul(dmat2x2_t a,double b) { dmat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline dmat3x2_t dmat3x2smul(dmat2x2_t a,double b) { dmat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline dmat3x3_t dmat3x3smul(dmat3x3_t a,double b) { dmat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline dmat4x3_t dmat4x3smul(dmat2x2_t a,double b) { dmat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }
static inline dmat4x4_t dmat4x4smul(dmat4x4_t a,double b) { dmat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]*b; return res; }

static inline dmat2x2_t dmat2x2sdiv(dmat2x2_t a,double b) { dmat2x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline dmat3x2_t dmat3x2sdiv(dmat2x2_t a,double b) { dmat3x2_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline dmat3x3_t dmat3x3sdiv(dmat3x3_t a,double b) { dmat3x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline dmat4x3_t dmat4x3sdiv(dmat2x2_t a,double b) { dmat4x3_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
static inline dmat4x4_t dmat4x4sdiv(dmat4x4_t a,double b) { dmat4x4_t res; for(int i=0;i<sizeof(a.m)/sizeof(a.m[0]);i++) res.m[i]=a.m[i]/b; return res; }
