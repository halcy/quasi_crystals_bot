...
{
	mat3x3_t res;
	float det=mat3x3det(m); // singular if det==0
...
{
	mat3x2_t res;
	float det=mat3x2affinedet(m); // singular if det==0
...
{
	mat3x3_t res;
	float det=mat3x3affinedet(m); // singular if det==0
...
{
	mat4x3_t res;
	float det=mat4x3affinedet(m); // singular if det==0
...
{
	float z=v.x*m.m[2]+v.y*m.m[5]+m.m[8];
	return vec2(
